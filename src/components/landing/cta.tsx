...
export function CTA() {
  return (
    <section className="relative py-24 bg-gradient-to-br from-zinc-950 to-black overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Communication?</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <SignedOut>
            <SignUpButton mode="modal">
              <Button 
                size="lg" 
                className="px-8 py-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-xl border-0 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition-all duration-200"
              >
                Get Started Free
              </Button>
            </SignUpButton>
